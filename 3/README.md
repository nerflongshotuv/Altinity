...
2. Enabling `log_queries` and monitoring
    ...
    - Improvements
        - Projections
            ...
            ```
            - Rows scanned ![rows](./images/8.png) ![explain](./images/9.png)
            ```sql
            ...
            ```
            - Rows scanned ![rows](./images/10.png) ![explain](./images/11.png)
            ```sql
            ...
            ```
            - Rows scanned ![rows](./images/12.png) ![explain](./images/13.png)
        - Summing Merge Tree
            ```sql
            ...
            ```
            - Query Improvments ![qi](./images/14.png)
